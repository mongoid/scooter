...
object Serialization {
   ...
   */
  implicit def dumpable(target: Double): Writable = new BsonDouble(target)
   ...
   */
  implicit def dumpable(target: Boolean): Writable = new BsonBoolean(target)
   ...
   */
  implicit def dumpable(target: Int): Writable = new BsonInt(target)
   ...
   */
  implicit def dumpable(target: Long): Writable = new BsonLong(target)
   ...
   */
  implicit def dumpable(target: String): Writable = new BsonString(target)
}
